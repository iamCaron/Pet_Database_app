...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // Get Induvidual views that we want t modify in the list item layout
        TextView tvName = (TextView) view.findViewById(R.id.name);
        TextView tvSummary = (TextView) view.findViewById(R.id.summary);
        ImageView ivPetImage=(ImageView)view.findViewById(R.id.image);
        ...
        Log.d(TAG, "bindView: "+breedColumnIndex);
        Log.d(TAG, "bindView: "+imageColumnIndex);
